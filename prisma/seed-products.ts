  ...
  "home-and-kitchen": [
    {
      ...
      comparePrice: 129.99,
      stock: 25,
      imageUrls: ["https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=500&h=500&fit=crop"],
      badge: "SALE",
    },
    {
      ...
      price: 24.99,
      stock: 45,
      imageUrls: ["https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=500&h=500&fit=crop"],
    },
    {
      ...
      comparePrice: 49.99,
      stock: 35,
      imageUrls: ["https://images.unsplash.com/photo-1593618998160-e34014e67546?w=500&h=500&fit=crop"],
      badge: "BEST_SELLER",
    },
    {
      ...
      price: 29.99,
      stock: 40,
      imageUrls: ["https://images.unsplash.com/photo-1591081351946-39d1d8ebc724?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 22.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1577003832154-a7d0b5e5b4b1?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 12.99,
      stock: 60,
      imageUrls: ["https://images.unsplash.com/photo-1585516160749-963b7f7e71e2?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 19.99,
      stock: 55,
      imageUrls: ["https://images.unsplash.com/photo-1590509904352-1d32e12d7d91?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 14.99,
      stock: 70,
      imageUrls: ["https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 9.99,
      stock: 80,
      imageUrls: ["https://images.unsplash.com/photo-1578500494198-246f612d03b3?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 27.99,
      stock: 30,
      imageUrls: ["https://images.unsplash.com/photo-1563189557-d63cb92d996b?w=500&h=500&fit=crop"],
    },
    {
      name: "Salad Spinner",
      ...
      price: 16.99,
      stock: 45,
      imageUrls: ["https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=500&h=500&fit=crop"],
    },
    {
    ...
    },
    {
      ...
      comparePrice: 59.99,
      stock: 20,
      imageUrls: ["https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=500&h=500&fit=crop"],
      badge: "NEW",
    },
    {
      ...
      comparePrice: 69.99,
      stock: 25,
      imageUrls: ["https://images.unsplash.com/photo-1571115564919-a0e1e1e2e8e5?w=500&h=500&fit=crop"],
      badge: "BEST_SELLER",
    },
    {
      ...
      price: 18.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1586010007235-7d4e5379b7d0?w=500&h=500&fit=crop"],
    },
  ],
  "cleaning-supplies": [
    {
      ...
      price: 14.99,
      stock: 100,
      imageUrls: ["https://images.unsplash.com/photo-1588345921523-c2dcdb7f1dcd?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 8.99,
      stock: 150,
      imageUrls: ["https://images.unsplash.com/photo-1584268545671-c90de20786ce?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 11.99,
      stock: 80,
      imageUrls: ["https://images.unsplash.com/photo-1563893113759-f3dd8b09cc2f?w=500&h=500&fit=crop"],
    },
    {
      ...
      comparePrice: 59.99,
      stock: 30,
      imageUrls: ["https://images.unsplash.com/photo-1563293026-ef19c329f43e?w=500&h=500&fit=crop"],
      badge: "SALE",
    },
    {
  ...
  "tools-and-hardware": [
    {
      ...
      comparePrice: 119.99,
      stock: 20,
      imageUrls: ["https://images.unsplash.com/photo-1572981522632-8ddac2ee6d4a?w=500&h=500&fit=crop"],
      badge: "BEST_SELLER",
    },
    {
      name: "Hammer Set",
      ...
      price: 19.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1517420879526-29e3b0e60ce6?w=500&h=500&fit=crop"],
    },
    {
  ...
  "patio-and-garden": [
    {
      ...
      price: 34.99,
      stock: 40,
      imageUrls: ["https://images.unsplash.com/photo-1560493676-04071c5f467b?w=500&h=500&fit=crop"],
    },
    {
      name: "Watering Can",
      ...
      price: 12.99,
      stock: 80,
      imageUrls: ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=500&fit=crop"],
    },
    {
  ...
  "pet-supplies": [
    {
      ...
      price: 49.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=500&h=500&fit=crop"],
    },
    {
      name: "Cat Litter Box",
      ...
      price: 34.99,
      stock: 40,
      imageUrls: ["https://images.unsplash.com/photo-1558788353-f76d92427f16?w=500&h=500&fit=crop"],
    },
    {
  ...
  "toys": [
    {
      ...
      price: 34.99,
      stock: 45,
      imageUrls: ["https://images.unsplash.com/photo-1565040666747-69f6646db940?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 19.99,
      stock: 60,
      imageUrls: ["https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?w=500&h=500&fit=crop"],
    },
    {
    ...
    },
    {
      ...
      price: 24.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?w=500&h=500&fit=crop"],
    },
    {
      ...
      comparePrice: 74.99,
      stock: 35,
      imageUrls: ["https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=500&h=500&fit=crop"],
      badge: "BEST_SELLER",
    },
    {
      ...
      comparePrice: 119.99,
      stock: 25,
      imageUrls: ["https://images.unsplash.com/photo-1561070791-2526d30994b5?w=500&h=500&fit=crop"],
      badge: "SALE",
    },
    {
    ...
    },
    {
      ...
      comparePrice: 84.99,
      stock: 20,
      imageUrls: ["https://images.unsplash.com/photo-1444080748397-f442aa95c3e5?w=500&h=500&fit=crop"],
      badge: "NEW",
    },
    {
      name: "Art Supply Set",
      ...
      price: 19.99,
      stock: 70,
      imageUrls: ["https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 29.99,
      stock: 40,
      imageUrls: ["https://images.unsplash.com/photo-1510915360826-d53c537394fa?w=500&h=500&fit=crop"],
    },
    {
  ...
  "general-merchandise": [
    {
      ...
      price: 12.99,
      stock: 200,
      imageUrls: ["https://images.unsplash.com/photo-1569163139394-de4798aa62b2?w=500&h=500&fit=crop"],
    },
    {
      ...
      price: 8.99,
      stock: 150,
      imageUrls: ["https://images.unsplash.com/photo-1625948515291-69613efd103f?w=500&h=500&fit=crop"],
    },
    {
    ...
    },
    {
      ...
      price: 24.99,
      stock: 60,
      imageUrls: ["https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?w=500&h=500&fit=crop"],
    },
    {
      ...
      comparePrice: 99.99,
      stock: 35,
      imageUrls: ["https://images.unsplash.com/photo-1587829191301-21a97e1e2c12?w=500&h=500&fit=crop"],
      badge: "SALE",
    },
    {
      name: "Mouse Wireless",
      ...
      price: 18.99,
      stock: 120,
      imageUrls: ["https://images.unsplash.com/photo-1527814050087-3793815479db?w=500&h=500&fit=crop"],
    },
    {
      name: "USB Hub 7-Port",
    ...
    },
    {
      ...
      comparePrice: 139.99,
      stock: 30,
      imageUrls: ["https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=500&h=500&fit=crop"],
      badge: "BEST_SELLER",
    },
    {
      ...
      price: 24.99,
      stock: 100,
      imageUrls: ["https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=500&h=500&fit=crop"],
    },
    {
      ...
      comparePrice: 59.99,
      stock: 50,
      imageUrls: ["https://images.unsplash.com/photo-1565636192335-14c0c3ecd5d8?w=500&h=500&fit=crop"],
      badge: "NEW",
    },
    {
      name: "Smart Plug",
      ...
      price: 12.99,
      stock: 150,
      imageUrls: ["https://images.unsplash.com/photo-1559654850-1d679f8fe0ad?w=500&h=500&fit=crop"],
    },
    {
      name: "Desk Lamp LED",
...
async function main() {
  console.log("🌱 Seeding 100 test products...");
  ...
  console.log("\n✅ Seeding complete! 100 products added.");
}
